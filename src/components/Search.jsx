...
const Search = () => {
  ...
  return (
    <div className="absolute bottom-0 w-full px-6 max-sm:px-1 max-[340px]:w-80 flex justify-center">
      <div className="flex items-center justify-between gap-5 bg-[#f0f4f9] py-3 px-5 rounded-full my-5 w-full max-[340px]:w-72 max-sm:px-2 max-sm:gap-2 max-[340px]:gap-1">
        <input
          type="text"
